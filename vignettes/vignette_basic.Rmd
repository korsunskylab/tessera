...
Run the Tessera algorithm to get tiles in one function. The result is returned in two structures:
...
p1 = ggplot() +
    geom_polygon(data = tile_poly, aes(x, y, group = .tile_group), fill = NA, color = 'grey70') +
    ...
    NULL
p2 = ggplot() +
    geom_polygon(data = tile_poly, aes(x, y, group = .tile_group, fill = seurat_clusters), alpha = .2) +
